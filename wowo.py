...
#cl = LineClient()
cl = LineClient(authToken='EHEdUyN7v5kTICxQIUD7.hz46BYRkxwOdFEYFX+V5jW.6KXea9cxwDhQfx+Z0ndkTbAVXKCsoPgbFGG5JYQ0Tyg=')
    ...
    try:
            ...
            if mid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        cl.sendMessage(op.param1,"Mikum, salken ya all mem " +str(ginfo.name))
                        cl.sendMessage(op.param1,"Welcome on ")
                    else:
                        cl.acceptGroupInvitation(op.param1)
                        ginfo = cl.getGroup(op.param1)
                        cl.sendMessage(op.param1,"Mikum, salken ya all mem " + str(ginfo.name))
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  sendMention(op.param1, op.param1, "Thx udh add ", ", Salken")
            ...
            if cctv['cyduk'][op.param1]==True:
                if op.param1 in cctv['point']:
                    ...
                    if Name in cctv['sidermem'][op.param1]:
                        ...
                        foto1 = ('https://i.ibb.co/4SySVGL/ezgif-com-gif-maker-2.gif','https://i.ibb.co/b7qJFW5/IMG-20210423-082406.jpg','https://i.ibb.co/1RZBmbG/images-5-1587981457466.jpg','https://i.ibb.co/vvZ6hv3/20210414-001303.jpg','https://i.ibb.co/x1zJRq7/images-27.jpg','https://i.ibb.co/HdBJHBw/images-25.jpg','https://i.ibb.co/y0Trf68/images-14.jpg')
                        fotonya1 = random.choice(foto1)
                        data = {
                                "type": "flex",
                                "altText": "Desah bebs",
                                "contents":{
...
#===========Hiburan============#
  ...
  "body": {
    ...
    "contents": [
      {
        "type": "image",
        "url": "https://s8.gifyu.com/images/1605554307131.jpg",
        "size": "full",
        "aspectMode": "cover",
        "aspectRatio": "1:1",
        "gravity": "center"
